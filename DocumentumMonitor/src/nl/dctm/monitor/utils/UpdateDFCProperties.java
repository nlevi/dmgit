...
//		URL url = ClassLoader.getSystemResource("dfc.properties");
		if(url == null) {
			return;
		}
...
//		URL url = ClassLoader.getSystemResource("dfc.properties");
		if(url == null) {
			logger.warn("Properties file URL: " + ClassLoader.getSystemResource("dfc.properties"));
//			return;
		} else {
			logger.warn("Properties file URL: " + ClassLoader.getSystemResource("dfc.properties"));
		}
		...
		System.out.println(dslist.isEmpty());
